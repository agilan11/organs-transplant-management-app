        ...
        <table className="table-auto border w-full my-2">
          <thead>
            <tr>
              ...
              <th className="px-4 py-2 border">Organ Status</th>
              <th className="px-4 py-2 border">Organ ID</th>
              <th className="px-4 py-2 border">Hospital</th>
              <th className="px-4 py-2 border">Email</th>
              <th className="px-4 py-2 border">Phone</th>
              <th className="px-4 py-2 border">Address</th>
              <th className="px-4 py-2 border">Creation Date and Time</th>
              <th className="px-4 py-2 border">Updation Date and Time</th>
    ...
    <Fragment>
      ...
      <tr className="border-b">
        ...
        <td className="hover:bg-gray-200 p-2 text-center cursor-default">
          ...
          {order.status === "Organ Dispatched" && (
            <span className="block text-green-600 rounded-full text-center text-xs px-2 font-semibold">
              {order.status}
            </span>
          )}
          {order.status === "Organ Delivered" && (
            <span className="block text-red-600 rounded-full text-center text-xs px-2 font-semibold">
              {order.status}
            </span>
          )}
