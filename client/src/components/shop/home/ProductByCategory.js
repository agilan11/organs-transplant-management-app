...
const Submenu = ({ category }) => {
  ...
  return (
    <Fragment>
      {/* Submenu Section */}
      <section className="mx-4 mt-32 md:mx-12 md:mt-40 lg:mt-32">
        <div className="flex justify-between items-center">
          <div className="text-sm flex space-x-3">
            ...
            >
              <FiArrowLeft className="text-4xl hover:text-white hover:bg-black" />
            </span>
            <span className="text-black cursor-default text-4xl font-bold ml-4">{category}</span>
          </div>
          {/* 
          <div>
            <svg
